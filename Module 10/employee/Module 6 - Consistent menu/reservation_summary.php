...
<head>
    ...
    <style>
        ...
        /* Invert coral-outline buttons on hover/focus for clarity */
        .reservation-actions .cancel-reservation:hover,
        .reservation-actions .btn.cancel:hover,
        .reservation-actions .cancel-reservation:focus,
        .reservation-actions .btn.cancel:focus {
            background: #E8896B !important;
            color: #ffffff !important;
